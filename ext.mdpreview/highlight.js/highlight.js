            ...
            function mergeStreams(stream1, stream2, value) {
                ...
                function selectStream() {
                    if (stream1.length && stream2.length) {
                        if (stream1[0].offset != stream2[0].offset) return (stream1[0].offset < stream2[0].offset) ? stream1 : stream2;
                        else {
                            /*
          ...
          */
            ...
            function compileLanguage(language) {
                ...
                function langRe(value, global) {
                    return RegExp(
                    value, 'm' + (language.case_insensitive ? 'i' : '') + (global ? 'g' : ''));
                }
...
*/
    ...
    hljs.GET_LANGUAGES = function(lang,callback) {
        if(!hljs.LOADING_LANGUAGES[lang]){
            hljs.LOADING_LANGUAGES[lang] = true;
            require(["./"+lang+".js"], function(_lang) {
                hljs.LANGUAGES[lang] = _lang(hljs);
                if(callback)callback();
            });
        }
    };

hljs.AVAIL_LANGUAGES = {};
hljs.LOADING_LANGUAGES = {};


    hljs.AVAIL_LANGUAGES['bash'] = true; //require('./bash.js')(hljs);
    hljs.AVAIL_LANGUAGES['erlang'] = true; //require('./erlang.js')(hljs);
    hljs.AVAIL_LANGUAGES['cs'] = true; //require('./cs.js')(hljs);
    hljs.AVAIL_LANGUAGES['brainfuck'] = true; //require('./brainfuck.js')(hljs);
    hljs.AVAIL_LANGUAGES['ruby'] = true; //require('./ruby.js')(hljs);
    hljs.AVAIL_LANGUAGES['rust'] = true; //require('./rust.js')(hljs);
    hljs.AVAIL_LANGUAGES['rib'] = true; //require('./rib.js')(hljs);
    hljs.AVAIL_LANGUAGES['diff'] = true; //require('./diff.js')(hljs);
    hljs.AVAIL_LANGUAGES['javascript'] = true; //require('./javascript.js')(hljs);
    hljs.AVAIL_LANGUAGES['js'] = true; //require('./javascript.js')(hljs);
    hljs.AVAIL_LANGUAGES['glsl'] = true; //require('./glsl.js')(hljs);
    hljs.AVAIL_LANGUAGES['rsl'] = true; //require('./rsl.js')(hljs);
    hljs.AVAIL_LANGUAGES['lua'] = true; //require('./lua.js')(hljs);
    hljs.AVAIL_LANGUAGES['xml'] = true; //require('./xml.js')(hljs);
    hljs.AVAIL_LANGUAGES['markdown'] = true; //require('./markdown.js')(hljs);
    hljs.AVAIL_LANGUAGES['css'] = true; //require('./css.js')(hljs);
    hljs.AVAIL_LANGUAGES['lisp'] = true; //require('./lisp.js')(hljs);
    hljs.AVAIL_LANGUAGES['profile'] = true; //require('./profile.js')(hljs);
    hljs.AVAIL_LANGUAGES['http'] = true; //require('./http.js')(hljs);
    hljs.AVAIL_LANGUAGES['java'] = true; //require('./java.js')(hljs);
    hljs.AVAIL_LANGUAGES['php'] = true; //require('./php.js')(hljs);
    hljs.AVAIL_LANGUAGES['haskell'] = true; //require('./haskell.js')(hljs);
    hljs.AVAIL_LANGUAGES['1c'] = true; //require('./1c.js')(hljs);
    hljs.AVAIL_LANGUAGES['python'] = true; //require('./python.js')(hljs);
    hljs.AVAIL_LANGUAGES['smalltalk'] = true; //require('./smalltalk.js')(hljs);
    hljs.AVAIL_LANGUAGES['tex'] = true; //require('./tex.js')(hljs);
    hljs.AVAIL_LANGUAGES['actionscript'] = true; //require('./actionscript.js')(hljs);
    hljs.AVAIL_LANGUAGES['sql'] = true; //require('./sql.js')(hljs);
    hljs.AVAIL_LANGUAGES['vala'] = true; //require('./vala.js')(hljs);
    hljs.AVAIL_LANGUAGES['ini'] = true; //require('./ini.js')(hljs);
    hljs.AVAIL_LANGUAGES['d'] = true; //require('./d.js')(hljs);
    hljs.AVAIL_LANGUAGES['axapta'] = true; //require('./axapta.js')(hljs);
    hljs.AVAIL_LANGUAGES['perl'] = true; //require('./perl.js')(hljs);
    hljs.AVAIL_LANGUAGES['scala'] = true; //require('./scala.js')(hljs);
    hljs.AVAIL_LANGUAGES['cmake'] = true; //require('./cmake.js')(hljs);
    hljs.AVAIL_LANGUAGES['objectivec'] = true; //require('./objectivec.js')(hljs);
    hljs.AVAIL_LANGUAGES['avrasm'] = true; //require('./avrasm.js')(hljs);
    hljs.AVAIL_LANGUAGES['vhdl'] = true; //require('./vhdl.js')(hljs);
    hljs.AVAIL_LANGUAGES['coffeescript'] = true; //require('./coffeescript.js')(hljs);
    hljs.AVAIL_LANGUAGES['nginx'] = true; //require('./nginx.js')(hljs);
    hljs.AVAIL_LANGUAGES['erlang-repl'] = true; //require('./erlang-repl.js')(hljs);
    hljs.AVAIL_LANGUAGES['r'] = true; //require('./r.js')(hljs);
    hljs.AVAIL_LANGUAGES['json'] = true; //require('./json.js')(hljs);
    hljs.AVAIL_LANGUAGES['django'] = true; //require('./django.js')(hljs);
    hljs.AVAIL_LANGUAGES['delphi'] = true; //require('./delphi.js')(hljs);
    hljs.AVAIL_LANGUAGES['vbscript'] = true; //require('./vbscript.js')(hljs);
    hljs.AVAIL_LANGUAGES['mel'] = true; //require('./mel.js')(hljs);
    hljs.AVAIL_LANGUAGES['dos'] =  true; //require('./dos.js')(hljs);
    hljs.AVAIL_LANGUAGES['apache'] =  true; //require('./apache.js')(hljs);
    hljs.AVAIL_LANGUAGES['applescript'] =  true; //require('./applescript.js')(hljs);
    hljs.AVAIL_LANGUAGES['cpp'] =  true; //require('./cpp.js')(hljs);
    hljs.AVAIL_LANGUAGES['matlab'] =  true; //require('./matlab.js')(hljs);
    hljs.AVAIL_LANGUAGES['parser3'] =  true; //require('./parser3.js')(hljs);
    hljs.AVAIL_LANGUAGES['clojure'] =  true; //require('./clojure.js')(hljs);
    hljs.AVAIL_LANGUAGES['go'] = true; //require('./go.js')(hljs);
